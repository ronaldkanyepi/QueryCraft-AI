...
mcp = FastMCP(name="TheAnalyst",instructions="""This server provides seamless interaction with the database and its also provide analytical capabilities""",version="1.0.1")
...
if __name__ == "__main__":
    mcp.run(transport='streamable-http',host=settings.MCP_SERVER_HOST,port=settings.MCP_SERVER_PORT)
